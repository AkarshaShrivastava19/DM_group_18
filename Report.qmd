...
customer <- dbGetQuery(ecomdata, "SELECT * FROM customer")
product <- dbGetQuery(ecomdata, "SELECT * FROM product")
supplier <- dbGetQuery(ecomdata, "SELECT * FROM supplier")
category <- dbGetQuery(ecomdata, "SELECT * FROM category")
shipment <- dbGetQuery(ecomdata, "SELECT * FROM shipment")
promotion <- dbGetQuery(ecomdata, "SELECT * FROM promotion")
orders <- dbGetQuery(ecomdata, "SELECT * FROM orders")
```
...
```{sql, eval=TRUE, connection = ecomdata}
SELECT 
    gender, 
